...
const All = (props) => {
  let classes =
    props.category.toLowerCase(GAME_CATEGORY.ALL) ===
    GAME_CATEGORY.ALL.toLowerCase()
      ? "selected clickable"
      : "not-selected clickable";

  return (
    <table onClick={() => props.onFilter(GAME_CATEGORY.ALL)}>
      <tbody className={classes}>
        ...
        <tr>
          <td className="filter-icon-text">All</td>
        </tr>
      </tbody>
    </table>
  );
